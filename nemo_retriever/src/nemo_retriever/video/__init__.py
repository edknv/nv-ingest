...
"""
Video pipeline: frame extraction (VideoFrameActor), full-frame captioning
(VideoFrameCaptionActor), and audio+visual fusion (AudioVisualFuser).

Audio-from-video and ASR are still handled by the existing
:mod:`nemo_retriever.audio` actors; this module adds the frame-caption and
...
from nemo_retriever.video.caption_actor import VideoFrameCaptionActor
from nemo_retriever.video.caption_actor import VideoFrameCaptionCPUActor
