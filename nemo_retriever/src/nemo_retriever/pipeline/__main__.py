...
def run(
    ...
    video_vlm_max_tokens: int = typer.Option(
        1024,
        "--video-vlm-max-tokens",
        help="Cap on VLM caption output tokens. Lower values reduce vLLM KV-cache reservation per prompt and let larger effective batches fit, raising throughput.",
        rich_help_panel=_PANEL_VIDEO,
    ),
    video_vlm_temperature: float = typer.Option(
        0.0,
        "--video-vlm-temperature",
