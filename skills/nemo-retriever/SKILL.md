...
This skill targets engine **contract_version 1.3.0** (`contract/cli-contract.json`). On the setup turn, after the index is built, verify the installed engine matches:
