...
class ExtractTaskSchema(BaseModel):
    ...
    table_content_format: str = "pseudo_markdown"
...
class ExtractTask(Task):
    ...
    def __init__(
        ...
        self._table_content_format = table_content_format
    ...
    def __str__(self) -> str:
        ...
        info += f"  table content format: {self._table_content_format}\n"
        return info
    ...
    def to_dict(self) -> Dict:
        ...
        extract_params = {
            ...
            "table_content_format": self._table_content_format,
        }
